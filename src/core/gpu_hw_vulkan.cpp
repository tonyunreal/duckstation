...
bool GPU_HW_Vulkan::BlitVRAMReplacementTexture(const TextureReplacements::ReplacementTexture* tex, u32 dst_x, u32 dst_y,
                                               u32 width, u32 height)
{
  ...
  const VkImageBlit blit = {
    ...
    {
      {0, 0},
      {static_cast<int32_t>(tex->GetWidth()), static_cast<int32_t>(tex->GetHeight())},
    },
    {VK_IMAGE_ASPECT_COLOR_BIT, 0u, 0u, 1u},
    {{static_cast<int32_t>(dst_x), static_cast<int32_t>(dst_y)},
     {static_cast<int32_t>(dst_x + width), static_cast<int32_t>(dst_y + height)}},
  };
