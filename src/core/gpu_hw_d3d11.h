...
private:
  ...
  bool UpdateVRAMReplacementTexture(const TextureReplacements::ReplacementTexture* tex);
  bool BlitVRAMReplacementTexture(const TextureReplacements::ReplacementTexture* tex, u32 dst_x, u32 dst_y, u32 width,
                                  u32 height);
